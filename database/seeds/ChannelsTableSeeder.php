...
',
        ...
        channels::create([
            ...
            'description_channel'   => "Nhóm Idol khá nổi tiếng của Nhật Bản được thành lập năm 2014. Thành viên trẻ tuổi nhất sinh năm 2004 Hiruta Airi. Các thành viên nổi tiếng nhất nhóm là Nemoto Nagi, Moe Tsurumi, Akari Nakamura, Karin Matoba, Ao Yamato. Đặc biệt, Nemoto Nagi là thành viên gánh team và đang hoạt động cho Dempagumi.inc.
...
',
        ...
        channels::create([
            ...
            'description_channel'   => "Đây là trang tổng hợp tất cả trận đấu LMHT của các giải đấu lớn như LCK, LPL, LMS, LCS... ",
        ...
        channels::create([
            ...
            'description_channel'   => "Là kênh Youtube dịch anime qua tiếng Hàn. Trong đây có trọn bộ bản dịch tiếng Hàn Date a live. NVHAI dịch Date a live dựa trên kênh này là chủ yếu.",
        ...
        channels::create([
            ...
            'description_channel'   => "Tôi Đi Code Dạo là một bloger nổi tiếng do anh Phạm Huy Hoàng tạo nên để chia sẻ kinh nghiệm trong ngành lập trình. Anh hiện đang làm việc ở Singapore. Bạn anh là thầy Song hiện đang mở trung tâm tin học Cybersoft và anh thường đến để gặp mặt các bạn sinh viên, những người đang theo học tại trung tâm.",
        ...
        channels::create([
            ...
            'description_channel'   => "Trang nghe nhạc Nightcore. NVHAI ấn tượng với bài RISE và bài DARKSIDE",
        ...
        channels::create([
            ...
            'description_channel'   => "Kênh Youtube chuyên đăng các bản nhạc không lời cover từ các bài hát nổi tiếng như Kimi no nawa, Lion King... Video nhiều lượt xem nhất của kênh đạt 35 triệu views. Các bản nhạc nhẹ nhàng, sâu lắng, thích hợp cho những ai cần tập trung làm việc, học tập.",
        ...
        channels::create([
            ...
            'description_channel'   => "Naomi Wu là cô gái đến từ Thâm Quyến, Trung Quốc. Với bộ ngực silicon đầy gợi cảm cùng chủ đề liên quan đến công nghệ, cô đã thu hút về gần 1 triệu lượt subcribe. Video của cô xoay quanh các đồ chơi công nghệ như camera 360, bàn chải đánh răng máy. Cô tự nhận mình là SexyCybor",
        ...
        channels::create([
            ...
            'description_channel'   => "Ririchiyo Neko là một nữ vũ công người Trung Quốc. Cô có nhiều video múa rất đẹp. 2 video hơn 1 triệu view của cô là Tougen Renka và cover AIAIAI của KizunaAI.",
        ...
        channels::create([
            ...
            'description_channel'   => "Ask Me Why - Hiểu Biết Hơn Mỗi Ngày là kênh về kiến thức. Series nổi tiếng nhất kênh là Lời Nguyền Địa Lý của các quốc gia như Việt Nam, Trung Quốc, Iran.",
            'favorite'              => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Pan Piano là một nghệ sĩ piano. Cô thường cosplay những nhân vật anime khi đánh bản nhạc của bộ anime đó. Bộ ngực luôn là điểm nhấn trong tất cả bản nhạc của cô.",
            'favorite'              => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Kênh chính thức của Riot Games dành cho trò chơi League of Legends.",
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Kênh chuyên chiếu sự kiện dành cho người lớn tại Trung Quốc. KINGDOM NVHAI thích kênh này vì một video cosplay Yoshino và Kurumi trong Date a live.",
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Khánh Mũ Đen sống tại Hà Nội. Khoảng năm 2015 - 2017 là thời điểm Khánh hoạt động mạnh, nổi tiếng với việc chơi game RPG kinh dị. Hiện giờ Khánh ít chơi game hơn và đang mở tiệm bán Vape ở Tây Hồ. Khánh đã có nút bạc Youtube vào năm 2016.",
            'enable_channel'        => 0,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Kênh này chuyên chơi game kinh dị. Mọi thể loại game kinh dị từ RPG, Visual Novel phương đông phương tây cho đến game hành động kinh dị đều được kênh Youtube này chơi, rất phù hợp với những ai đang tìm một kho game kinh dị.",
            'favorite'              => 0,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Kênh Youtube của Vietnam Esport TV, chuyên đăng video các trận đấu LMHT tại VCS từ thời Saigon Joker 2012 đến nay.",
            'favorite'              => 0,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Koko a Music là cô gái VTuber chủ yếu theo lĩnh vực âm nhạc, chỉ đăng video chơi nhạc dài từ 3-5 phút nhưng số subcribe rất khủng. Cô cover những bài hát như God knows, No pain, No game...",
            'virtual_youtuber'      => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => 'Không muốn nằm ngoài cuộc chơi, hãng nước lọc Suntory cũng tung ra VTuber của mình là Suntory Nomu. KINGDOM NVHAI biết đến cô khi cô xuất hiện cùng Tokino Sora của Hololive. Trang chủ <a href="https://www.suntory.co.jp/enjoy/socialmedia/nomu/" target="_blank">Suntory Nomu</a>',
            'virtual_youtuber'      => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Hololive là công ty giải trí thành lập nên một nhóm gồm các Virtual Youtuber - gọi tắt là VTuber - nhằm cạnh tranh miếng bánh Virtual Youtuber đang nổi lên khắp Nhật Bản.",
            'favorite'              => 1,
            'virtual_youtuber'      => 1,
            'hololive'              => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Tokino Sora - Vtuber đầu tiên của Hololive. Cô là senpai đời đầu của Hololive mà các đàn em phải ngưỡng mộ và học hỏi.
        ...
        channels::create([
            ...
            'description_channel'   => "Mio Channel là Virtual Youtuber chuyên chơi game là lập nhóm với các Virtual Youtuber khác. Cô là một nữ sói đen. KINGDOM NVHAI thích kênh này từ bài hát cover Sparkle với đồ họa 4K sắc nét. Cảnh Mio trong bầu trời xanh, chiều tà và đêm xuống với thiên thạch đang rơi xuống, nếu chỉnh trong độ phân giải 4K thì không thể chê vào đâu được.",
            'virtual_youtuber'      => 1,
            'hololive'              => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'       => "Houshou Marine là VTuber của Hololive. Cô theo phong cách cướp biển. Và nhắc tới cướp biển, không thể không cover bài He's a pirate trong phim Pirates of Caribbean. Cô có khả năng vẽ rất tốt. Nhưng điểm nổi tiếng nhất của cô là tuổi tác. Video nhảy cùng Natsumi và vốn kiến thức về anime của cô khiến ai cũng đoán cô là thế hệ 9X đời đầu.",
            'enable_channel'            => 0,
            'virtual_youtuber'  => 1,
            'hololive'          => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'       => "Matsuri là Vtuber của Hololive. Cô nổi tiếng với những câu chuyện nhạy cảm, chửi bới nhưng rất hài hước.",
            'enable_channel'            => 0,
            'virtual_youtuber'  => 1,
            'hololive'          => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'       => "Okayu là Vtuber của Hololive.",
            'enable_channel'            => 0,
            'virtual_youtuber'  => 1,
            'hololive'          => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Himemori Luna là VTuber của Hololive. Cô nổi tiếng với phần lớp học tiếng Anh ngắn trong chương trình Coco News. Những từ cô nói trong lớp tiếng Anh toàn những từ nói tục, không phù hợp với phong cách công chúa chút nào.",
            'enable_channel'        => 1,
            'virtual_youtuber'      => 1,
            'hololive'              => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Hoshimachi Suisei là VTuber của Hololive. Cô mang hình ảnh của một thần tượng và có khả năng chơi Tetris rất giỏi.",
            'enable_channel'        => 1,
            'virtual_youtuber'      => 1,
            'hololive'              => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Subaru là VTuber của Hololive. Cô là một tomboy, kể mình đã vào Hololive sau khi nhà của cô bị cháy. Cô nổi tiếng từ video nói rằng sẽ làm một buổi stream ASMR (buổi stream âm thanh nói qua micro 2 tai). Kết quả là cô bị gán danh hiệu Donald Duck vì giọng tomboy vịt đực của mình.",
            'enable_channel'        => 1,
            'virtual_youtuber'      => 1,
            'hololive'              => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Korone là VTuber của Hololive. Cô mang hình dạng một con sói, luôn luôn vui vẻ. Cô có một cái gối ôm hình ngón tay và đã từng chơi game HEAVY RAIN có cảnh chặt ngón tay. Từ đó, cô nổi tiếng là một kẻ chuyên sưu tầm ngón tay.",
            'enable_channel'        => 1,
            'virtual_youtuber'      => 1,
            'hololive'              => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Là kênh Youtube dịch VTuber. KINGDOM NVHAI biết đến kênh này nhờ video về Tokino Sora.",
            'enable_channel'        => 1,
            'visual_novel'          => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Là kênh Youtube dịch VTuber. Kênh này có vẻ rất thích Haato của Hololive",
            'enable_channel'        => 1,
            'visual_novel'          => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Là kênh Youtube dịch VTuber của Hololive.",
            'enable_channel'        => 1,
            'visual_novel'          => 1,
        ]);
        ...
        channels::create([
            ...
            'description_channel'   => "Là kênh chuyên dịch Hololive.",
            'enable_channel'        => 1,
            'visual_novel'          => 1,
        ]);
